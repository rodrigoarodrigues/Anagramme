# Termo Clone - Development Plan

## Project Overview
A Brazilian Wordle clone called "Termo" using .NET 9, React with TypeScript (Vite), Docker, and SQL Server.

**Termo** is a Brazilian word-guessing game where players have 6 attempts to guess a 5-letter Portuguese word, with color-coded feedback after each guess.
...
│   ├── Termo.Infrastructure/   # Data access, external services
...
Termo.Infrastructure/     # Data layer
├── Data/
│   ├── TermoDbContext.cs
│   └── Repositories/
├── Services/
...
services:
  termo-api:
    ...
    environment:
      ...
      - ConnectionStrings__DefaultConnection=Server=sqlserver;Database=TermoDB;User Id=sa;Password=YourPassword123!;TrustServerCertificate=true;
    depends_on:
      - sqlserver
    networks:
      - termo-network
...
This development plan provides a comprehensive roadmap for building the Termo clone. Update this document as you progress and make decisions about pending items.
